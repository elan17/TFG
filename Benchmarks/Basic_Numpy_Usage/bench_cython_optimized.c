...
static CYTHON_INLINE int __pyx_f_22bench_cython_optimized_dot(__Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
...
static const char __pyx_k_np_add[] = "np_add";
static const char __pyx_k_np_dot[] = "np_dot";
...
static const char __pyx_k_returneo_view[] = "returneo_view";
...
static PyObject *__pyx_n_s_np_add;
static PyObject *__pyx_n_s_np_dot;
...
static PyObject *__pyx_n_s_returneo_view;
...
static CYTHON_INLINE int __pyx_f_22bench_cython_optimized_dot(__Pyx_memviewslice __pyx_v_slice1, __Pyx_memviewslice __pyx_v_slice2) {
 ...
 *   for x in range(l):
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_slice1); 
  __pyx_v_l = __pyx_t_1;
 ...
 */
    __pyx_t_5 = __pyx_v_x;
    __pyx_t_6 = __pyx_v_x;
    __pyx_v_r = (__pyx_v_r + ((*((int *) ( /* dim=0 */ (__pyx_v_slice1.data + __pyx_t_5 * __pyx_v_slice1.strides[0]) ))) + (*((int *) ( /* dim=0 */ (__pyx_v_slice2.data + __pyx_t_6 * __pyx_v_slice2.strides[0]) )))));
  }

  /* "bench_cython_optimized.pyx":14
 *   for x in range(l):
 *     r += slice1[x] + slice2[x]
 *   return r             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pf_22bench_cython_optimized_autocorrelation(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_vec) {
  ...
  __Pyx_memviewslice __pyx_v_returneo_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  int __pyx_v_d1;
  int __pyx_v_d2;
  CYTHON_UNUSED PyObject *__pyx_v_np_dot = NULL;
  CYTHON_UNUSED PyObject *__pyx_v_np_add = NULL;
  ...
  __pyx_pybuffernd_vec.rcbuffer = &__pyx_pybuffer_vec;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_vec.rcbuffer->pybuffer, (PyObject*)__pyx_v_vec, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 18, __pyx_L1_error)
  }
 ...
 *     l = len(n)
 */
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(((PyObject *)__pyx_v_vec), PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 20, __pyx_L1_error)
  __pyx_v_n = __pyx_t_1;
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 21, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_returneo = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "bench_cython_optimized.pyx":24
 *     l = len(n)
 *     returneo = np.empty_like(vec)
 *     cdef int[:] returneo_view = returneo             # <<<<<<<<<<<<<<
 *     cdef int[:]s1, s2, ns1, ns2
 *     cdef int d1, d2
 */
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_v_returneo, PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 24, __pyx_L1_error)
  __pyx_v_returneo_view = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_add); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_np_add = __pyx_t_2;
  __pyx_t_2 = 0;
 ...
 */
    __pyx_v_d1 = __pyx_f_22bench_cython_optimized_dot(__pyx_v_s1, __pyx_v_ns1);

    /* "bench_cython_optimized.pyx":36
 *         ns2 = n1[:off]
 *         d1 = dot(s1, ns1)
 *         d2 = dot(s2, ns2)             # <<<<<<<<<<<<<<
 *         returneo_view[x] = d1 + d2
 *     return returneo
 */
    __pyx_v_d2 = __pyx_f_22bench_cython_optimized_dot(__pyx_v_s2, __pyx_v_ns2);

    /* "bench_cython_optimized.pyx":37
 *         d1 = dot(s1, ns1)
 *         d2 = dot(s2, ns2)
 *         returneo_view[x] = d1 + d2             # <<<<<<<<<<<<<<
 *     return returneo
 */
    ...
    *((int *) ( /* dim=0 */ (__pyx_v_returneo_view.data + __pyx_t_10 * __pyx_v_returneo_view.strides[0]) )) = (__pyx_v_d1 + __pyx_v_d2);
  }

  /* "bench_cython_optimized.pyx":38
 *         d2 = dot(s2, ns2)
 *         returneo_view[x] = d1 + d2
 *     return returneo             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_returneo_view, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_s1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_s2, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_ns1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_ns2, 1);
  __Pyx_XDECREF(__pyx_v_np_dot);
  __Pyx_XDECREF(__pyx_v_np_add);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_np_add, __pyx_k_np_add, sizeof(__pyx_k_np_add), 0, 0, 1, 1},
  {&__pyx_n_s_np_dot, __pyx_k_np_dot, sizeof(__pyx_k_np_dot), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_returneo_view, __pyx_k_returneo_view, sizeof(__pyx_k_returneo_view), 0, 0, 1, 1},
 ...
 *     cdef int[:]n = vec
 */
  __pyx_tuple__26 = PyTuple_Pack(16, __pyx_n_s_vec, __pyx_n_s_x, __pyx_n_s_l, __pyx_n_s_n, __pyx_n_s_n1, __pyx_n_s_returneo, __pyx_n_s_returneo_view, __pyx_n_s_s1, __pyx_n_s_s2, __pyx_n_s_ns1, __pyx_n_s_ns2, __pyx_n_s_d1, __pyx_n_s_d2, __pyx_n_s_np_dot, __pyx_n_s_np_add, __pyx_n_s_off); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(1, 0, 16, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_bench_cython_optimized_pyx, __pyx_n_s_autocorrelation, 18, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 18, __pyx_L1_error)
